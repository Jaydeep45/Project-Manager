        ...
        <table id="user-projects" class="table table-striped">
            ...
            <tbody>
                    <?php 
                        ...
                        echo "<tr><td>".$d['assign_name']."</td>"."<td>".$d['task_desc']."</td>"."<td>".$d['assign_email']."</td>"."<td>".$d['project_name']."</td><td>".$status."</td><td></td><td></td></tr>";
                        }
                    ?>
            </tbody>
        </table>
        ...
        $(document).ready(function () {
                ...
                "columnDefs": [
            {
                ...
                "render": function ( data, type, row, meta ) {
                    return '<a class="btn btn-sm btn-warning" href="project.php?project=' + row[3]+'">View</a>';
                }
            }, 
            {
                "targets": 6,
                "visible": true,
                    "render": function ( data, type, row, meta ) {
                    return '<a class="btn btn-sm btn-primary" href="download.php?project=' + row[3]+'">Download</a>';
                }
            } ]
